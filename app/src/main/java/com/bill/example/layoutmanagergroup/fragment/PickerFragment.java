...
import com.bill.layoutmanagergroup.picker.PickerLayoutManager;
...
public class PickerFragment extends Fragment  {
    ...
    private void initView(View rootView) {
        ...
        mPickerLayoutManager1 = new PickerLayoutManager(getContext(),mRecyclerView1, PickerLayoutManager.VERTICAL, false,5,0.4f,true);
        mRecyclerView1.setLayoutManager(mPickerLayoutManager1);
        mRecyclerView1.setAdapter(new MyAdapter(mHours));

        mPickerLayoutManager2 = new PickerLayoutManager(getContext(),mRecyclerView2, PickerLayoutManager.VERTICAL, false,5,0.4f,true);
